...
async function GetMovies(genrenum) {
    ...
    url = "https://api.themoviedb.org/3/movie/now_playing?api_key=59e021a2ceb89231493f66b6f99e095c&language=en-US&page=1";
    ...
    data.results.forEach(function (data) {
        ...
        data.genre_ids.forEach(function (ids) {
            ...
            if (ids === genrenum) {
                ...
                <a class="dropdown-item" href="http://localhost:3000/Movie_description/${_id}">Movie information</a>
                <a class="dropdown-item" href="http://localhost:3000/user/addto_towatch_movies/${_id}">want to watch</a>
                <a class="dropdown-item" href="http://localhost:3000/user/addto_Watched_Movies/${_id}">watched</a>
                </div>`;
...
async function getAllMovies() {
    ...
    // while (page_number < 5) {
        ...
        data.results.forEach(function (data) {
            ...
            // buton.setAttribute("onclick", `location.href = 'http://localhost:3000/Movie_description/${_id}';`);
            // buton.innerHTML = "View";
